...
export function DateReview(props: PropTypes) {
	...
	return (
		...
		>
			<div style={{ maxWidth: "100vw", width: 500, padding: 20 }}>
				<div style={{ marginTop: 50, fontSize: 25, textAlign: "center" }}>
					Please review your date with {(otherUser as UserMini).firstName}
					{isSetup ? "'s friend" : ""}
				</div>
				...
				<div style={toggleContainerGroup}>
					...
					<div style={toggleDivStyle}>
						<label>
							...
							/>
							<span style={toggleTextStyle}>
								Did you feel safe around your date?
							</span>
						</label>
					</div>
				</div>
				...
				<div style={toggleContainerGroup}>
					<div style={toggleDivStyle}>
						<label>
							...
							/>
							<span style={toggleTextStyle}>
								Would you go on a second date with this person?
							</span>
						</label>
					</div>
				</div>
				...
				<div
					...
					onClick={() => {
						let review: DateReview = {
							reviewee: (otherUser as UserMini)._id,
							dateObject: lockingDate._id,
							wasNoShow,
							wasCatfish,
							wasThreatening,
							intelligent,
